...
node.addService(pg.Execute(shell="bash", command="/local/repository/addRustVars.sh"))
node.addService(pg.Execute(shell="bash", command="/local/repository/aptSetup.sh"))
node.addService(pg.Execute(shell="bash", command="/local/repository/rustSetup.sh"))
